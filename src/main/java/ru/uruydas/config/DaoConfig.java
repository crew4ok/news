...
import ru.uruydas.dao.impl.jooq.JooqRecordMapperProvider;
import ru.uruydas.dao.impl.jooq.JooqTransactionProvider;
...
@Configuration
@ComponentScan(basePackages = "ru.uruydas.dao")
