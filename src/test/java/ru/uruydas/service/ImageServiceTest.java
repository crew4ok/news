...
import ru.uruydas.service.exception.ImageRetrievalFailedException;
import ru.uruydas.service.exception.ImageStoringFailedException;
import ru.uruydas.util.exception.InvalidParamException;
import ru.uruydas.service.impl.S3ImageService;
...
public class ImageServiceTest extends BaseServiceTest {
    ...
    public void getById_hp() throws Exception {
        ...
        assertEquals(request.getBucketName(), "uruydas-images");
    ...
    public void save_hp() throws Exception {
        ...
        assertEquals(actualRequest.getBucketName(), "uruydas-images");
